...
var _BitReader_data, _BitReader_byte, _BitReader_bytePosition, _BitReader_bitPosition, _Av1_Leb128Bytes, _Av1_OperatingPointIdc;
...
class BitReader {
    get byteAligned() {
        return __classPrivateFieldGet(this, _BitReader_bitPosition, "f") === 7;
    }
    get ended() {
        return __classPrivateFieldGet(this, _BitReader_bytePosition, "f") >= __classPrivateFieldGet(this, _BitReader_data, "f").length;
    }
    constructor(data) {
        _BitReader_data.set(this, void 0);
        _BitReader_byte.set(this, void 0);
        _BitReader_bytePosition.set(this, 0);
        _BitReader_bitPosition.set(this, 7);
        __classPrivateFieldSet(this, _BitReader_data, data, "f");
        __classPrivateFieldSet(this, _BitReader_byte, data[0], "f");
    }
    f1() {
        const value = __classPrivateFieldGet(this, _BitReader_byte, "f") >> __classPrivateFieldGet(this, _BitReader_bitPosition, "f");
        __classPrivateFieldSet(this, _BitReader_bitPosition, __classPrivateFieldGet(this, _BitReader_bitPosition, "f") - 1, "f");
        if (__classPrivateFieldGet(this, _BitReader_bitPosition, "f") < 0) {
            __classPrivateFieldSet(this, _BitReader_bytePosition, __classPrivateFieldGet(this, _BitReader_bytePosition, "f") + 1, "f");
            __classPrivateFieldSet(this, _BitReader_bitPosition, 7, "f");
            __classPrivateFieldSet(this, _BitReader_byte, __classPrivateFieldGet(this, _BitReader_data, "f")[__classPrivateFieldGet(this, _BitReader_bytePosition, "f")], "f");
        }
        return value & 1;
    }
    f(n) {
    ...
    skip(n) {
        if (n <= __classPrivateFieldGet(this, _BitReader_bitPosition, "f") + 1) {
            __classPrivateFieldSet(this, _BitReader_bytePosition, __classPrivateFieldGet(this, _BitReader_bytePosition, "f") + 1, "f");
            __classPrivateFieldSet(this, _BitReader_bitPosition, 7, "f");
            __classPrivateFieldSet(this, _BitReader_byte, __classPrivateFieldGet(this, _BitReader_data, "f")[__classPrivateFieldGet(this, _BitReader_bytePosition, "f")], "f");
            return;
        }
        n -= __classPrivateFieldGet(this, _BitReader_bitPosition, "f") + 1;
        __classPrivateFieldSet(this, _BitReader_bytePosition, __classPrivateFieldGet(this, _BitReader_bytePosition, "f") + 1, "f");
        const bytes = (n / 8) | 0;
        if (bytes > 0) {
            __classPrivateFieldSet(this, _BitReader_bytePosition, __classPrivateFieldGet(this, _BitReader_bytePosition, "f") + bytes, "f");
            n -= bytes * 8;
        }
        __classPrivateFieldSet(this, _BitReader_bitPosition, 7 - n, "f");
        __classPrivateFieldSet(this, _BitReader_byte, __classPrivateFieldGet(this, _BitReader_data, "f")[__classPrivateFieldGet(this, _BitReader_bytePosition, "f")], "f");
    }
    readBytes(n) {
        if (!this.byteAligned) {
        ...
        const value = __classPrivateFieldGet(this, _BitReader_data, "f").subarray(__classPrivateFieldGet(this, _BitReader_bytePosition, "f"), __classPrivateFieldGet(this, _BitReader_bytePosition, "f") + n);
        __classPrivateFieldSet(this, _BitReader_bytePosition, __classPrivateFieldGet(this, _BitReader_bytePosition, "f") + n, "f");
        __classPrivateFieldSet(this, _BitReader_byte, __classPrivateFieldGet(this, _BitReader_data, "f")[__classPrivateFieldGet(this, _BitReader_bytePosition, "f")], "f");
        return value;
    }
    getPosition() {
        return [__classPrivateFieldGet(this, _BitReader_bytePosition, "f"), __classPrivateFieldGet(this, _BitReader_bitPosition, "f")];
    }
    setPosition([bytePosition, bitPosition]) {
        __classPrivateFieldSet(this, _BitReader_bytePosition, bytePosition, "f");
        __classPrivateFieldSet(this, _BitReader_bitPosition, bitPosition, "f");
        __classPrivateFieldSet(this, _BitReader_byte, __classPrivateFieldGet(this, _BitReader_data, "f")[bytePosition], "f");
    }
}
_BitReader_data = new WeakMap(), _BitReader_byte = new WeakMap(), _BitReader_bytePosition = new WeakMap(), _BitReader_bitPosition = new WeakMap();
const ObuType = {
    SequenceHeader: 1,
    TemporalDelimiter: 2,
    FrameHeader: 3,
...
export class Av1 extends BitReader {
    constructor() {
        super(...arguments);
        _Av1_Leb128Bytes.set(this, 0);
        _Av1_OperatingPointIdc.set(this, 0);
    }
    /**
    ...
    leb128() {
        ...
        let value = 0n;
        __classPrivateFieldSet(this, _Av1_Leb128Bytes, 0, "f");
        for (let i = 0n; i < 8n; i += 1n) {
            const leb128_byte = this.f(8);
            value |= BigInt(leb128_byte & 0x7f) << (7n * i);
            __classPrivateFieldSet(this, _Av1_Leb128Bytes, __classPrivateFieldGet(this, _Av1_Leb128Bytes, "f") + 1, "f");
    ...
    *temporalUnit(sz) {
        while (sz > 0) {
            ...
            sz -= BigInt(__classPrivateFieldGet(this, _Av1_Leb128Bytes, "f"));
    ...
    *frameUnit(sz) {
    ...
    openBitstreamUnit(sz) {
        ...
        if (obu_header.obu_type !== Av1.ObuType.SequenceHeader &&
            ...
            __classPrivateFieldGet(this, _Av1_OperatingPointIdc, "f") !== 0 &&
            obu_header.obu_extension_header) {
            const inTemporalLayer = !!(__classPrivateFieldGet(this, _Av1_OperatingPointIdc, "f") &
                (1 << obu_header.obu_extension_header.temporal_id));
            const inSpatialLayer = !!(__classPrivateFieldGet(this, _Av1_OperatingPointIdc, "f") &
    ...
    sequenceHeaderObu() {
        ...
        __classPrivateFieldSet(this, _Av1_OperatingPointIdc, operating_point_idc[operatingPoint], "f");
...
_Av1_Leb128Bytes = new WeakMap(), _Av1_OperatingPointIdc = new WeakMap();
Av1.ObuType = ObuType;
Av1.ColorPrimaries = ColorPrimaries;
Av1.TransferCharacteristics = TransferCharacteristics;
Av1.MatrixCoefficients = MatrixCoefficients;
Av1.SelectScreenContentTools = 2;
Av1.SelectIntegerMv = 2;
