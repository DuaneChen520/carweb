...
export function parseSequenceParameterSet(nalu) {
 ...
 */
export function searchConfiguration(buffer) {
...
export function parseConfiguration(data) {
...
export function toCodecString(configuration) {
