...
export class AdbScrcpyOptions4_0<TVideo extends boolean>
    extends ScrcpyOptions4_0<TVideo>
    implements
        AdbScrcpyOptions<ScrcpyOptions4_0.Init<TVideo>>,
        AdbScrcpyOptionsGetEncoders
{
    ...
    constructor(
        init: ScrcpyOptions4_0.Init<TVideo>,
