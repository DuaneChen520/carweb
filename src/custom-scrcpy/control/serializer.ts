...
import { ResizeDisplayControlMessage } from "./resize-display.js";
...
export class ScrcpyControlMessageSerializer {
    ...
    resizeDisplay(width: number, height: number) {
        return ResizeDisplayControlMessage.serialize({
            type: this.getType(ScrcpyControlMessageType.ResizeDisplay),
            width,
            height,
        });
    }
